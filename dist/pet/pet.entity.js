...
], PetEntity.prototype, "nombre", void 0);
__decorate([
    typeorm_1.Column({
        type: "varchar",
        length: 100,
...
__decorate([
    typeorm_1.ManyToOne(type => user_entity_1.UserEntity, user => user.pets),
    __metadata("design:type", Number)
], PetEntity.prototype, "fkUser", void 0);
PetEntity = __decorate([
    typeorm_1.Entity("epn_pet")
], PetEntity);
